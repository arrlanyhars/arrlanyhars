...
🌱 As a digital talent at Telco Company, I’m currently learning **all about Big Data and Artificial Intelligence**. Well experienced in Python and Java programming language for 5++ years as a Fullstack Software Engineer and Fullstack Data Analytics Engineer (Data Analyst, Data Engineer, and Data Scientist) that enjoy writing Python code, Math and Stat theory for data science, doing analysis and visualization using Tableau, Looker Studio, and Power BI. Additionally, I am experienced with Fullstack Software Engineer with Python and Java for BackEnd side, ReactJS and VueJS for FrontEnd side.
...
<h3 align="left">☯️ Here is my Portfolio: </h3>
  ...
  <img src="https://carechemistry.com/images/giphy.gif" width="20" height="13"/> [Click My Portfolio](https://thisislani.com)
